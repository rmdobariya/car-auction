...
Route::group(['middleware' => ['websiteLanguageCheck']], function () {
    ...
    Route::post('login-send-otp', [LoginController::class, 'loginSendOtp'])->name('login-send-otp');
    ...
    Route::group(['middleware' => ['CheckUser']], function () {
        ...
        Route::get('car-for-sell-vehicle-details/{id}', [HomeController::class, 'carForSellVehicleDetail'])->name('car-for-sell-vehicle-details');
