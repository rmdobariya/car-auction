    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                @include('admin.layouts2.components.bread-crumbs',['main_name'=>'Bogs'])
                @include('admin.layouts2.components.create-button',['url'=>route('admin.blog.create')])
            ...
            <div id="kt_content_container" class="container-fluid">
                <div class="card">
                    <div class="card-header border-0 pt-6">
                        @include('admin.layouts2.components.search-text-box',['search_place_holder'=>'Search Blog'])
...
@section('custom-script')
    <script>
        const sweetalert_delete_title = "Blog Delete?"
        const sweetalert_delete_text = "Are You Sure Delete This Blog"
        const sweetalert_restore_title = "Blog Restore?"
        const sweetalert_restore_text = "Are You Sure Restore This Blog"
        const cancel_button_text = "Cancel"
        const delete_button_text = "Delete"
        const sweetalert_change_status = "Blog Status Change"
