    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                @include('admin.layouts2.components.bread-crumbs',['main_name'=>'Banners'])
...
@section('custom-script')
    <script>
        const sweetalert_delete_title = "Banner Delete?"
        const sweetalert_delete_text = "Are You Sure Delete This Banner"
        const sweetalert_restore_title = "Banner Restore?"
        const sweetalert_restore_text = "Are You Sure Restore This Banner"
        const cancel_button_text = "Cancel"
        const delete_button_text = "Delete"
        const sweetalert_change_status = "Banner Status Change"
        ...
        var arr = [];
        const multiple_select_title = "Selected Banner Delete ?"
