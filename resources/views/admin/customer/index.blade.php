                    ...
                    <div class="card-body pt-0">
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="basic-1">
                            ...
                            <tr class="text-start text-dark-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th>{{trans('admin_string.is_corporate_seller')}}</th>
                                <th>{{trans('admin_string.corporate_name')}}</th>
    ...
    <script>
        ...
        $.extend(true, $.fn.dataTable.defaults, {
            columns: [
                ...
                {data: 'is_corporate_seller', name: 'users.is_corporate_seller'},
                {data: 'corporate_seller', name: 'users.corporate_seller'},
