    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                @include('admin.layouts2.components.bread-crumbs',['main_name'=>'Categories'])
            ...
            <div id="kt_content_container" class="container-fluid">
                <div class="card">
                    <div class="card-header border-0 pt-6">
                        @include('admin.layouts2.components.search-text-box',['search_place_holder'=>'Search Category'])
...
@section('custom-script')
    <script>
        const sweetalert_delete_title = "Category Delete?"
        const sweetalert_delete_text = "Are You Sure Delete This Category"
        const sweetalert_restore_title = "Category Restore?"
        const sweetalert_restore_text = "Are You Sure Restore This Category"
        const cancel_button_text = "Cancel"
        const delete_button_text = "Delete"
        const sweetalert_change_status = "Category Status Change"
