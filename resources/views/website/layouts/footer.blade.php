    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <div class="copyright">
                    <div class="copy">
                        <p> © {{trans('web_string.zodha')}} {{date('Y')}} -  {{trans('web_string.all_rights_reserved')}}
{{--                            <a href="https://promarcreative.com" target="_blank" class="textWhite text-hover-primary">Crafted by ProMar Creative</a>--}}
                            .</p>
                    </div>
                    <div class="pagelink">
