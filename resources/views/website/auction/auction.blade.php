                    ...
                    <div class="heading">
                        ...
                        @if(!is_null(Auth::user()))
                            @if(Auth::user()->user_type == 'seller')
                                <a href="{{route('add-car')}}">{{trans('web_string.add_auction')}}</a>
                            @endif
                            {{--                        @else--}}
    ...
    //                                    $dateToCheck = Carbon\Carbon::parse(date('Y-m-d'));
                                    ...
                                    @if($dateToCheck->between($startDateTime, $endDateTime) == true)
                                        ...
                                        <span class="input-group-btn">
                                            ...
                                            <a class="btn place-bid-blue-manually @if($bid_count == 0 && $payment_status == 'pending') disabled-link @endif bid-manually-submit"
                                               data-id="{{$vehicle->id}}">
